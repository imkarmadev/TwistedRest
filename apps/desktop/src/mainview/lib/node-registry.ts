...
export const NODE_REGISTRY: NodeTypeDef[] = [
  ...
  // ── HTTP Server nodes ────────────────────────────────────────────
  {
    type: "httpListen",
    label: "HTTP Listen",
    category: "HTTP Server" as NodeCategory,
    description: "Process node: starts an HTTP server, emits events per request via OnEvent.",
    component: SystemNode,
    hasExecIn: true,
    hasExecOut: false,
    hasDataIn: false,
  ...
  },
  {
    ...
    label: "Route Match",
    category: "HTTP Server" as NodeCategory,
    description: "Check if a request matches a method + path. Use with If/Else to route.",
    component: SystemNode,
    hasExecIn: false,
    hasExecOut: false,
    hasDataIn: true,
